    ...
    <div class="home">
        <div class="home_container">
            @if(!empty($item->images))
                <div class="home_background" style="background-image:url(/images/{{ $item->images[0]->img }}.jpg)"></div>
            @else
                <div class="home_background" style="background-image:url(/images/no_images.png)"></div>
            @endif
                ...
                <div class="col-lg-6">
                    <div class="details_image">
                        ...
                        <div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
                            ...
                            @foreach($item->images as $object)
                                <div class="details_image_thumbnail" data-image="/images/{{ $object->img }}.jpg"><img
