...
{{--                                <li><a href="{{ route('showProduct', $category->alias) }}">{{ $category->title }}</a></li>--}}
{{--                            @endforeach--}}
{{--                        </ul>--}}
{{--                    @endsection--}}
                </div>
                        ...
                        @foreach($products as $product)
                            ...
                            <div class="product">
                                ...
                                <div class="product_content">
                                    <div class="product_title"><a href="{{ route('showProduct', [$product->category, $product->id]) }}">{{$product->title}}</a></div>
                                    @if($product->new_price != null)
                                        <div class="product-price" style="text-decoration: line-through">${{ $product->price }}</div>
